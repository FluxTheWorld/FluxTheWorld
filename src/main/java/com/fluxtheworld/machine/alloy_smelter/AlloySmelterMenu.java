...
public class AlloySmelterMenu extends MachineMenu<AlloySmelterBlockEntity, AlloySmelterMenuLayout> {
  ...
  @Override
  protected AlloySmelterMenuLayout createMenuLayout() {
    return new AlloySmelterMenuLayout(this.playerInventory, this.blockEntity);
  }
